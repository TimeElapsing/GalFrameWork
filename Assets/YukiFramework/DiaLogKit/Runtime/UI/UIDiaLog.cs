...
namespace YukiFrameWork.DiaLogue
{
	...
	public class UIDiaLog : MonoBehaviour
	{
        ...
        #region 调用Auto_Reset_MoveNext方法的自动对话器设置
        ...
        private Action onFinshTypewriterCallBack;       
        ...
        {           
            ...
            if (playMode == DiaLogPlayMode.Writer)
            {
                ...
                onFinshTypewriterCallBack = OnFinish;
        ...
        private IEnumerator Update_Context(string content)
        {
            ...
            yield return null;
            onFinshTypewriterCallBack?.Invoke();
        }
